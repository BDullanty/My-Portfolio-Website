...
export function HomePageAboutMe() { 
    return (
        <Paper elevation={10} className='HomepageInnerPaper'sx={{background:'var(--card-background-color)', color:'var(--primary-text-color)',
            ':hover': {
          boxShadow: 15}}}>
        <h4 className="HomePage-Card-Title">About Brady:</h4>
        <h6 className="HomePage-Card-Content">
                Brady Dullanty is a dedicated computer science student with six months remaining until graduation in March 2024.
                <br /><br />
                He has honed strong skills in program development, cybersecurity, computer networking, and cloud computing, particularly with AWS services.
                <br /><br />
                Through diverse coursework in programming, mathematics, cybersecurity, and networking, he has gained the expertise necessary to build robust applications free from vulnerabilities.
                <br /><br />
                Brady thrives on tackling complex problems and enjoys implementing effective solutions, supported by a solid foundation in data structures, algorithms, and database systems.
            </h6><br />
      </Paper>
    )
} 
